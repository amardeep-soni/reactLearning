...
const Card = (props) => {
    ...
    return (
        <div className="border-2 m-2 border-black w-[250px]">
            <img src={imgurl} alt="profileImage" className="w-full h-60 bg-[#f5f5f5]" />
            <div className="p-3">
                <div>
            ...
            <div className="flex">
                ...
                <p className="bg-slate-200 w-full p-2 center border-l-2 border-r-2 border-slate-400 cursor-pointer hover:bg-slate-400 text-xl" onClick={() => {
                    handleShowModal(id);
                    handleId(id);
                }}>
                    <CiEdit />
